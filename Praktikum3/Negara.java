...
public class Negara {
    ...
    void tampilkan(){
        ...
        if (jenis.equalsIgnoreCase("presiden")||jenis.equalsIgnoreCase("perdana menteri")) {
        System.out.println("Negara "+nama+" mempunyai "+jenis+" bernama "+namapresiden);}
        else if (jenis.equalsIgnoreCase("monarki")){
            System.out.println("Negara "+nama+" mempunyai Raja"+" bernama "+namapresiden+"\n");
        }
        if (jenis.equalsIgnoreCase("presiden")||jenis.equalsIgnoreCase("perdana menteri")) {
